...
parser = OptionParser()
parser.add_option("-n", "--name", dest="dbname", help="give name of database to create", default="wow-auctions", metavar="DBNAME")
...
connection = Connection(options.dbhost, options.dbport)
